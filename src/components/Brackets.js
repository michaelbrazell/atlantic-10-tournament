  ...
  render() {
    return (
      <div>
        ...
        <hr />
        <h3 className="mb-3" id="Official">Bracket - Official</h3>
        ...
        <hr />
        <h3 className="mb-3" id="John">Bracket - John</h3>
        <div className="row bracket-group">
          <div className="col">
            <h4>March 7 <span className="badge badge-secondary float-right">2</span></h4>
            <hr />
        ...
        <hr />
        <h3 className="mb-3" id="Kevin">Bracket - Kevin</h3>
        <div className="row bracket-group">
          <div className="col">
            <h4>March 7 <span className="badge badge-secondary float-right">2</span></h4>
            <hr />
        ...
        <hr />
        <h3 className="mb-3" id="Chris">Bracket - Chris</h3>
        <div className="row bracket-group">
          <div className="col">
            <h4>March 7 <span className="badge badge-secondary float-right">2</span></h4>
            <hr />
        ...
        <hr />
        <h3 className="mb-3" id="Mike">Bracket - Mike</h3>
        <div className="row bracket-group">
          <div className="col">
            <h4>March 7 <span className="badge badge-secondary float-right">2</span></h4>
            <hr />
